...
const modules = ['auth', 'sync-tracking', 'user-devices', 'notification','device','group','house','space','sharedPermission','shareRequest','alert-type','alert','firmware','firmware-update-history','ownershipHistory','ticket-type','ticket'];
